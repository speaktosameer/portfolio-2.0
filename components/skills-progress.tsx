...
const skills: Skill[] = [
  ...
  { name: "Node.js", level: 75, category: "Backend", color: "from-green-500 to-green-700" },
  { name: "Python", level: 70, category: "Backend", color: "from-blue-500 to-yellow-500" },
  { name: "PostgreSQL", level: 72, category: "Backend", color: "from-blue-600 to-indigo-600" },
  { name: "MongoDB", level: 68, category: "Backend", color: "from-green-600 to-green-800" },
